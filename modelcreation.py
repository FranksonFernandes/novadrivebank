...
# Garantir que o diretório objects exista
...
y_train = np.array([mapeamento[item.lower()] for item in y_train])
y_test = np.array([mapeamento[item.lower()] for item in y_test])
